...
map<string> blockConditions = null;
map<any> throttleDataMap = null;
public stream<RequestStreamDTO> requestStream = null;
public stream<GlobalThrottleStreamDTO> globalThrottleStream = null;
public boolean isStreamsInitialized = null;
